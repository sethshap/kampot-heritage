import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, u as useLanguage, d as useNavigate, X, B as Button } from "./index-DzwzmQd8.js";
import { u as useActor, U as UserRole, P as PreferredLanguage, c as createActor } from "./backend-BGqH3Hc2.js";
import { I as Input, S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem, L as Label } from "./select-YVq2fIQY.js";
import { T as Textarea } from "./textarea-CIMfzUdz.js";
import { u as useTranslations } from "./useTranslations-D3DJerXi.js";
import { C as ChevronRight } from "./chevron-right-BecEts6e.js";
...
function SectionHeader({ step, title }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-full bg-primary flex items-center justify-center text-primary-foreground text-sm font-bold font-display flex-shrink-0", children: step }),
...
function ChampionOnboardingPage() {
  ...
  const [photoDataUrl, setPhotoDataUrl] = reactExports.useState(null);
  const [photoError, setPhotoError] = reactExports.useState("");
  const fileInputRef = reactExports.useRef(null);
  const [referralStatus, setReferralStatus] = reactExports.useState("idle");
  const [referralChampionName, setReferralChampionName] = reactExports.useState("");
  const [referralError, setReferralError] = reactExports.useState("");
  ...
  const handlePhotoChange = reactExports.useCallback((file) => {
    if (!file) return;
  ...
  const validateReferralCode = reactExports.useCallback(
    async (code) => {
      if (!code.trim()) {
  ...
  const validate = reactExports.useCallback(() => {
    ...
    if (referralStatus === "checking") {
      newErrors.referralCode = "Please wait for referral code validation to complete.";
    }
    setErrors(newErrors);
    ...
    async (e) => {
      ...
      try {
        const res = await actor.registerUser({
          ...
          fullNameKm: form.fullNameKm.trim() || void 0,
          fullNameFr: form.fullNameFr.trim() || void 0,
          phoneNumber: form.phoneNumber.trim(),
          avatarUrl: photoDataUrl ?? void 0,
          bioEn: form.bioEn.trim() || void 0,
          bioKm: form.bioKm.trim() || void 0,
          bioFr: form.bioFr.trim() || void 0,
          referredByCode: referralStatus === "valid" && form.referralCode.trim() ? form.referralCode.trim() : void 0,
  ...
  if (submitted) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-background flex items-center justify-center px-4 py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-2xl border border-border p-8 shadow-lg text-center", children: [
          photoPreview && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: photoPreview,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-full bg-accent/20 flex items-center justify-center mx-auto mb-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-9 h-9 text-accent" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold text-foreground mb-2", children: t("champion_pending") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mb-3", children: "A staff member will contact you with your QR code and referral code." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "Thank you for joining the Kampot Heritage family!" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 pt-5 border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Questions? Visit our community or speak with any staff member." }) })
        ] })
      }
    ) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-background min-h-screen", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border-b border-border py-10 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-2xl mx-auto text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1.5 text-xs font-semibold tracking-widest text-accent uppercase mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "w-3 h-3" }),
            t("social_mission")
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-3xl sm:text-4xl font-bold text-foreground mb-3", children: t("champion_onboarding_title") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-base max-w-lg mx-auto", children: "Join our community of champions selling Kampot Heritage artisanal soap" })
        ]
      }
    ) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-2xl mx-auto px-4 py-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, noValidate: true, "data-ocid": "onboarding.form", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { step: 1, title: "Your Identity" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-4", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "ឈ្មោះ​ពេញ (ខ្មែរ) — optional", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Preferred language", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Select,
                {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          className: "bg-card rounded-2xl border border-border p-6 mb-6 shadow-sm",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { step: 2, title: t("champion_upload_photo") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                ref: fileInputRef,
                ...
                onChange: (e) => {
                  var _a;
                  return handlePhotoChange((_a = e.target.files) == null ? void 0 : _a[0]);
                },
                "data-ocid": "onboarding.photo_file_input"
              }
            ),
            photoPreview ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2 min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-foreground font-medium flex items-center gap-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-4 h-4 text-accent" }),
                  "Photo selected"
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Looking great! Your photo will be shown to hotels and the community." }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    type: "button",
              ...
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-14 rounded-full bg-primary/10 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Camera, { className: "w-7 h-7 text-primary" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium text-foreground text-sm", children: "Upload your photo" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "Drag & drop or click to browse · JPG, PNG up to 5MB" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    Button,
                    {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          className: "bg-card rounded-2xl border border-border p-6 mb-6 shadow-sm",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { step: 3, title: t("champion_tell_story") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mb-4 -mt-2", children: "Sharing your story helps hotels and customers connect with you. Optional but highly encouraged." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 gap-4", children: lang === "km" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "រឿងរ៉ាវ (ខ្មែរ) — optional", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              Textarea,
              {
                value: form.bioKm,
            ...
            ) }) : lang === "fr" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Votre histoire (Français) — optional", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              Textarea,
              {
                value: form.bioFr,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { step: 4, title: "Your Referral" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Field,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute right-3 top-1/2 -translate-y-1/2", children: [
                      referralStatus === "checking" && /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-4 h-4 animate-spin text-muted-foreground" }),
                      referralStatus === "valid" && /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-4 h-4 text-accent" }),
                      referralStatus === "invalid" && /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "w-4 h-4 text-destructive" })
                    ] })
                  ] }),
                  referralStatus === "valid" && referralChampionName && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-accent font-medium flex items-center gap-1 mt-1", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-3.5 h-3.5" }),
                    "Referred by ",
                    referralChampionName
                  ] })
                ]
              }
            )
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-primary/5 border border-primary/20 rounded-xl p-4 mb-5 text-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground font-medium", children: t("mission_statement") }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: t("income_goal") })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-xs text-muted-foreground mt-3", children: "By submitting, you agree to be contacted by Kampot Heritage staff for verification." })
          ]
        }
      )
    ] }) })
...
export {
  ChampionOnboardingPage as default
};
